...
void setup() {
  Serial.begin(115200);
  analogReadResolution(10);     // กำหนดระดับค่าที่อ่านได้จากขา A0 (ข้อมูลดิบจาก potentiometer 0-4095)
...
void loop() {
  ...
  value = analogRead(sig);                  // กำหนดค่าในตัวแปร value เป็นค่าจากการอ่านค่า analog จากขา SIG (ใส่ A0 เลยก็ได้)
